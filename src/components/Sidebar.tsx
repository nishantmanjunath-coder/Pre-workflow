      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-1">
            <button className="flex items-center space-x-3 w-full px-3 py-2 bg-purple-50 text-purple-600 rounded-lg font-medium">
        ...
        {/* Playground */}
        <div className="mb-6">
          <button className="flex items-center space-x-3 w-full px-3 py-2 bg-green-100 text-green-800 rounded-lg font-medium">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-yellow-50 rounded-lg p-3 flex items-center space-x-2">
          <div className="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center flex-shrink-0">
            <svg className="w-5 h-5 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-1 6h2v6h-2v-6zm6-2h-2v2h2v-2zm0 4h-2v2h2v-2z"/>
              <circle cx="9" cy="9" r="1"/>
              <circle cx="15" cy="9" r="1"/>
            </svg>
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-gray-900 truncate">Yellow Travels - Sample AI...</div>
          </div>
        </div>
      </div>
    </aside>
